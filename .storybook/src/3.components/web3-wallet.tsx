...
const transactions = [
  {description: 'Approve DROP', status: "unconfirmed", txHahs: '0x5eA3c06ad387aF16F77fC2f1eD7fC2C7aF3B75c1', showIfClosed: true},
      ...
      return (
        <AxisTheme>
          <Box gap={"medium"} pad={"medium"}>
            <Web3Wallet address="0x5eA3c06ad387aF16F77fC2f1eD7fC2C7aF3B75c1" providerName="MetaMask"
              networkName="Mainnet" onDisconnect={() => console.log('disconnect clicked')}
              transactions={[]} getAddressLink={getAddressLink} />
          </Box>
        </AxisTheme>
      );
    };
            ...
            >
              <Box direction="row" width="xlarge" align="center">
                <Box align="center" direction="row" basis="full">
                  <Web3Wallet address="0x5eA3c06ad387aF16F77fC2f1eD7fC2C7aF3B75c1" providerName="MetaMask"
                    networkName="Mainnet" onDisconnect={() => console.log('disconnect clicked')}
                    transactions={[]} getAddressLink={getAddressLink} style={{ marginLeft: 'auto' }} />
                </Box>
              </Box>
            </Box>
          </Box>
            ...
            >
              <Box direction="row" width="xlarge" align="center">
                <Box align="center" direction="row" basis="full">
                  <Web3Wallet address="0x5eA3c06ad387aF16F77fC2f1eD7fC2C7aF3B75c1" providerName="MetaMask"
                    networkName="Mainnet" onDisconnect={() => console.log('disconnect clicked')}
                    transactions={transactions} getAddressLink={getAddressLink} style={{ marginLeft: 'auto' }} />
                </Box>
              </Box>
            </Box>
          </Box>
